...
public class ParkingController {
	...
	/*@GetMapping("/api/find/{premiseId}")
	public ResponseEntity<List<ParkingSlots>> getParkingSlotsByPremise(@PathVariable int premiseId)
	{
		ParkingPremise premise =adminService.readParkingPremiseById(premiseId);
		return new ResponseEntity<List<ParkingSlots>>(parkingService.findSlotsByPremise(premise),HttpStatus.OK);
	}*/
